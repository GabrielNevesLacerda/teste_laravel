...
<html lang="pt-br">
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('images/logo-brasileirao.png')}}">
  ...
  <body>
    <header>
      <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="#">
          <img src="{{asset('images/logo-brasileirao.png')}}" width="50" height="50" alt="">
        </a>
      </nav>
    </header>
    <main role="main">
    ...
    <script src="{{asset('js/pageController.js')}}"></script>
  </body>
</html>